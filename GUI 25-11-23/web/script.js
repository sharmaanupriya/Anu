...
function goHome() {
  ...
  eel.goHome(selectedComPort + ',' + selectedBaudRate, {
...
function backToSecondPage() {
  ...
  // Clear input values on the fourth page
  document.getElementById("diameterInput").value = ""; // Replace with the actual ID of your input element
  // Add more lines for other input elements on the fourth page as needed

  // Clear input values on the fifth page
  document.getElementById("diameterInput2").value = ""; // Replace with the actual ID of your input element
  document.getElementById("currentInput").value = ""; // Replace with the actual ID of your input element
  document.getElementById("currentInput2").value = ""; // Replace with the actual ID of your input element
  document.getElementById("diameterInput3").value = ""; // Replace with the actual ID of your input element
  // Add more lines for other input elements on the fifth page as needed

  // Clear input values on the sixth page
  document.getElementById("hours").value = ""; // Replace with the actual ID of your input element
  document.getElementById("minutes").value = ""; // Replace with the actual ID of your input element
  document.getElementById("seconds").value = ""; // Replace with the actual ID of your input element
  // Add more lines for other input elements on the sixth page as needed
...
function startCountdown() {
  ...
  sendAcknowledgmentToMachine(specifiedTime / 1000);
...
function sendAcknowledgmentToMachine(seconds) {
  ...
  eel.sendAcknowledgmentToMachine(seconds); // passing seconds as an argument
}
...
function connectDisconnect() {
  ...
  const buttonText = connectDisconnectButton.innerText;
